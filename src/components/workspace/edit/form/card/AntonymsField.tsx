...
export default function AntonymsField({ control, tagsValue, setValue }: Props) {
  ...
  return (
    <div className='*:not-first:mt-2'>
      <FormField
        ...
        render={({ field }) => (
          <FormItem className=''>
            <FormLabel className='mt-2 text-left'>Add Antonyms</FormLabel>
            <FormDescription>
              Add antonyms to the card. ( e.g. bad, poor, terrible )
            </FormDescription>
            <FormControl>
              <TagInput
                {...field}
